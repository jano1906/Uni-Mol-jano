...
data_path="$HOME/datasets/molecular_property_prediction/tox21"  # replace to your data path
save_dir=./save_pretrain                                        # replace to your save path
n_gpu=1                                                         # Set this to desired number of gpus
MASTER_PORT=10086
lr=1e-4
wd=1e-4
batch_size=16                                                   # Set largest possible batchsize
update_freq=1
masked_token_loss=1
masked_coord_loss=5
masked_dist_loss=10
...
unicore-train $data_path  --user-dir ./unimol --train-subset train --valid-subset valid \
       ...
       --joint-learning --max-seq-len 256